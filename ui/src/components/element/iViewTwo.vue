<template>
    <div id="iViewTwo">
        ...
        <Form ref="forms" :model="formItem" :label-width="100">
            ...
            <FormItem label="选择器">
                <Select v-model="formItem.select" v-validate="'required'" disabled
                        name="选择器">
                    <Option value="beijing">New York</Option>
                    <Option value="shanghai">London</Option>
                    <Option value="shenzhen">Sydney</Option>
            ...
            <FormItem label="选择器">
                <div style="display: flex;justify-content: space-between">
                    <DatePicker type="date" placeholder="选择日期" style="width: 45%"></DatePicker>
                    -
                    <TimePicker type="time" placeholder="选择时间" style="width: 45%"></TimePicker>
                </div>
            </FormItem>
            <FormItem label="多选框">
                <CheckboxGroup v-model="formItem.checkbox">
                    ...
                    <Checkbox label="玩" disabled></Checkbox>
                </CheckboxGroup>
            </FormItem>
            ...
            <FormItem label="附件">
                ...
                <span style="color: #c5cacf">仅支持上传png,jpg,jpeg,svg格式文件</span>
            </FormItem>
            <FormItem label="文本框">
            ...
            <FormItem style="margin-top: 20px">
                <Button type="primary" @click="confirmData()">提交</Button>
                <Button class="margin-left10" @click="clearVal()">重置</Button>
            </FormItem>
        </Form>
        <!--</div>-->
        <!--</Col>-->
